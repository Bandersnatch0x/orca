...
// Re-exported so the page's `.web.ts` sibling can answer the same three names without the
// document string: whatever imports this gets markup and style on both platforms.
export { TERMINAL_DOCUMENT_MARKUP } from './terminal-webview-html/document-markup'
export { TERMINAL_DOCUMENT_STYLE } from './terminal-webview-html/document-style'
